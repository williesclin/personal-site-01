export const authCopy = {
 en: {
  ...
  'auth.scope':'Sign-in forms are bilingual. The member workspace and password-setting page reached from a reset email remain in Traditional Chinese.',
  'auth.demo':'Explore the demo (Traditional Chinese)', 'auth.demoHint':'Synthetic personal records and model results; no paid access or complete lottery tools.',
 ...
 'zh-hant': {
  ...
  'auth.scope':'登入表單提供中英文。會員工作台，以及由重設信進入的新密碼設定頁，目前仍為繁體中文。',
  'auth.demo':'探索示範工作台（繁中）', 'auth.demoHint':'個人紀錄與模型結果為合成資料，不開通付費權益或完整樂透工具。',
