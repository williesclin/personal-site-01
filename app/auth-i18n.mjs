export const authCopy = {
 en: {
  ...
  'auth.scope':'Member controls are available in English and Traditional Chinese. Saved notes, original sources and historical audit entries retain their original language.',
 ...
 'zh-hant': {
  ...
  'auth.scope':'會員操作提供中英文；已存備註、原始來源與歷史稽核紀錄保留原文。',
