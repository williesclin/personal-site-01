...
for(const locale of ['en','zh-hant'])for(const page of pages){
 ...
 const names=zh?{macro:'總經與經濟日曆',study:'財經研究路徑與比較',markets:'黃金與外匯',digital:'加密資產與穩定幣',lottery:'海內外樂透資料',search:'全站搜尋',coverage:'資料範圍',news:'新聞與事件',pricing:'會員方案',research:'股票與 ETF 研究',library:'知識庫',tools:'工具',methodology:'研究方法',about:'關於'}:{macro:'Macro & economic calendar',study:'Connected financial research',markets:'Gold & currencies',digital:'Crypto & stablecoins',lottery:'Lottery data directory',search:'Site search',coverage:'Data coverage',news:'News & events',pricing:'Membership plans',research:'Stocks & ETF research',library:'Library',tools:'Tools',methodology:'Methodology',about:'About'};
